...
class SupabaseLedger:
    ...
    def __init__(self, settings: Optional[Settings] = None) -> None:
        ...
        self.client: Client = create_client(
            self.settings.supabase_url_normalized(),
        ...
        *,
        ...
        try:
            ...
            if bucket not in names:
                # Create public bucket to match public URL usage
                self.client.storage.create_bucket(bucket, {"public": True})
        except Exception:
            # If we cannot list/create, proceed and let upload error surface
            pass
    ...
    def public_storage_url(self, *, bucket: str, dest_path: str) -> str:
